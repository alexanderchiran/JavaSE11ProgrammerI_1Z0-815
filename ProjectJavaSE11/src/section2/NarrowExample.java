...
public class NarrowExample {
    public static void main(String[] args) {
        ...
        System.out.println("1. A char has a range of " + String.format("\\u%04x  to \\u%04x", (int) Character.MIN_VALUE, (int) Character.MAX_VALUE));
        System.out.println("2. A char has a range of " + (int) Character.MIN_VALUE + "  to " + (int) Character.MAX_VALUE);
