 ...
 * we can access the static members of com.company.section1.a class directly without class name or any object. For Example:
 ...
 *
 * com.company.section1.a) static: los atributos miembros de una clase pueden ser atributos de clase o atributos de instancia;
 * se dice que son atributos de clase si se usa la palabra clave static: en ese caso la variable es única
 * para todas las instancias (objetos) de la clase (ocupa un único lugar en memoria). A veces com.company.section1.a las variables
 ...
 * un atributo común com.company.section1.a todos los objetos de esa clase.
 *
...
public class TestFQNC1 {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        com.company.section1.garden.vegetable.VineVegetable.main(argv);
    }
}
