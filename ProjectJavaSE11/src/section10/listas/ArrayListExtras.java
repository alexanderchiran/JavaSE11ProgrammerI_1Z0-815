...
public class ArrayListExtras {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. typedList = " + typedList);
        System.out.println("2. rawList = " + rawList);
        ...
        System.out.println("3. typedList = " + typedList);
        System.out.println("4. rawList = " + rawList);
...
//        typedList.add(typedList.size() + 1, new BaseClass("def"));
        ...
        System.out.println("5. typedList = " + typedList);
        System.out.println("6. rawList = " + rawList);
...
//        typedList.set(0, typedSubList);
        ...
        System.out.println("7. typedList = " + typedList);
        System.out.println("8. rawList = " + rawList);
