...
public class ToArrayExamples1 {
    public static void main(String[] args) {
        ...
        System.out.println("1. Result type from ArrayList<Integer> " +  "assigned to var = " +  eInt.getClass().getTypeName());
        System.out.println("1.1 --- Resulting array elements = " +   Arrays.toString(eInt));

        // No casting required.
        testValue = eInt[0];
        System.out.println("2. --- No cast required at individual level:" + " the first element is " + testValue);
        ...
        System.out.println("3. Result type from ArrayList assigned to var = " +  eRaw.getClass().getTypeName());
        System.out.println("4. --- Resulting array elements = " + Arrays.toString(eRaw));

        // Casting required.
        testValue = (int) eRaw[0];
        System.out.println("5. --- Cast required at individual level: the " + "first element is " + testValue);
        ...
        System.out.println("6. Result type from ArrayList<Integer> " + "assigned to var = " + fInt.getClass().getTypeName());
        System.out.println("7. --- Resulting array elements = " + Arrays.toString(fInt));

        // casting required.
        testValue = (int) fInt[0];
        System.out.println("8. --- Cast required at individual level:" + " the first element is " + testValue);

        // A raw ArrayList will still return a Number[] array

        var fRaw = rawList.toArray(new Number[0]);
        System.out.println("9. Result type from ArrayList assigned to var = " + fRaw.getClass().getTypeName());
        System.out.println("10. --- Resulting array elements = " + Arrays.toString(fRaw));

        // Casting required.
        testValue = (int) fRaw[0];
        System.out.println("11. --- Cast required at individual level: the " + "first element is " + testValue);
    }
