...
class Joke implements Laughable {
    public void laugh() {
        System.out.println("1. That joke is laughable");
    }
}
...
class Story {
    public void read() {
        System.out.println("2. This story is a good read");
    }
}
...
class FunnyStory extends Story implements Laughable {
    ...
    public void laugh() {
        System.out.println("3. That story is funny");
    }

    // overrides read() method from Story
    public void read() {
        System.out.println("4. This story is a good giggle");
    }
}
...
class Farce extends Story implements Laughable {
    public void laugh() {
        System.out.println("5. This story is funny in a farcical way");
    }
}
