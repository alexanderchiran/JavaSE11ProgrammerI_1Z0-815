...
public class StringBuilderExtras {
    public static void main(String[] args) {
        ...
        /*the next code produce error:
        Exception in thread "main" java.lang.StringIndexOutOfBoundsException: offset 3, count 7, length 5
        	at java.base/java.lang.String.checkBoundsOffCount(String.java:3304)
	        at java.base/java.lang.String.getChars(String.java:855)
	        at section3.stringbuilder.StringBuilderExtras.main(StringBuilderExtras.java:85)
         */
