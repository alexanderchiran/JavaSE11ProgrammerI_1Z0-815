...
public class StringCount {
    public static void main(String[] args) {
        ...
        stringReplaced = stringOriginal.replace('b', 'a');
        System.out.println("1.1  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced));
        ...
        stringReplaced = stringOriginal.substring(5, stringOriginal.length());
        System.out.println("9.1  stringOriginal==stringReplaced = " +
                (stringOriginal == stringReplaced));
