...
abstract class Sub extends Super {
    //'get()' in 'SimulationTest.exam6.Sub' clashes with 'get()' in 'SimulationTest.exam6.Super'; overridden method does not throw 'java.lang.Exception'
    //abstract ArrayList<AB> get() throws Exception;

    abstract ArrayList<AB> get() throws ArrayIndexOutOfBoundsException;

    //'get()' in 'SimulationTest.exam6.Sub' clashes with 'get()' in 'SimulationTest.exam6.Super'; attempting to use incompatible return type
