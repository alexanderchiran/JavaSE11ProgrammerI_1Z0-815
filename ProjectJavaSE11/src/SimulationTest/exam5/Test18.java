...
abstract class BeachTraveller extends Traveller {
    //'travel(String)' in 'SimulationTest.exam5.BeachTraveller' clashes with 'travel(String)' in 'SimulationTest.exam5.Traveller'; overridden method does not throw 'java.io.IOException
...
class N100 extends M100 {
    //Static method 'main(String[])' in 'SimulationTest.exam5.N' cannot override instance method 'main(String[])' in 'SimulationTest.exam5.M100
    //public static void main(String[] args) { //Line n2
