...
class Calculator4 implements Multiplier {
    //'multiply(int...)' in 'SimulationTest.one.exam6.exam5.Calculator4' clashes with 'multiply(int...)' in 'SimulationTest.one.exam6.exam5.Multiplier'; overridden method does not throw 'java.lang.Throwable'
    //public void multiply(int... x) throws Throwable {

    //'multiply(int...)' in 'SimulationTest.one.exam6.exam5.Calculator4' clashes with 'multiply(int...)' in 'SimulationTest.one.exam6.exam5.Multiplier'; overridden method does not throw 'java.io.IOException'
...
class Calculator5 implements Multiplier {
    //'multiply(int...)' in 'SimulationTest.one.exam6.exam5.Calculator5' clashes with 'multiply(int...)' in 'SimulationTest.one.exam6.exam5.Multiplier'; overridden method does not throw 'java.lang.Exception'
