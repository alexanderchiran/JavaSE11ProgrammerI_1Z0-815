...
public class ThrowsClauseExample {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 4; i++) {
            try {
                ...
                System.out.println("1. In the catch clause for" + " ACustomThrowable in main(): " +  te);
            } catch (AnError ae) {
                System.out.println("2. In the catch clause for" + " AnError in main(): " +  ae);
            } catch (ACustomRuntimeException are) {
                System.out.println("3. In the catch clause for" +" ACustomRuntimeException in main(): " +  are);

            } catch (RuntimeException e) {
                System.out.println("4. In the catch clause of main(): " + e);
            }
    ...
    private void methodTwo() {
        try {
            ...
            System.out.println("5. In the catch clause of methodTwo(): " +  e);
